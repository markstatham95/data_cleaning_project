...
full_candy <- candy_clean %>%
  ...
  mutate(country = str_replace_all(country, "soviet canukistan", NA_character_)) %>%
  mutate(country = str_replace_all(country, "canada'", "canada")) %>%
  mutate(country = str_replace_all(country, "not usa", NA_character_)) %>%
  mutate(country = str_replace_all(country, "ud", NA_character_)) %>%
  mutate(country = str_replace_all(country, "canae", NA_character_)) %>%
...
#i'm going to remove any data with age as above 
