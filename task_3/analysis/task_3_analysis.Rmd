...
#problem here - when i pull these commands through a lot of the data comes back as na - for example 'wandering albatross sensu lato pl2' should be in the top counts, but comes back as na...
